    ...
    function __construct($id, $label, $dropDownOptionArray, $optionArray = array()) {
        ...
        if(isset($optionArray['initialValue'])) {
            foreach ($this->dropDownOptionArray as $key => $value) {
                // check for array --> multiple select dropdown
                if (gettype($optionArray['initialValue']) == 'array'){
                    if (in_array($value['value'], $optionArray['initialValue'])){
